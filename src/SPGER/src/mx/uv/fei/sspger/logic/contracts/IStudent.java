...
public interface IStudent {
    ...
    List<Student> getAvailableStudentsNotInCourse() throws SQLException;
    ...
    int updateStudentWithPasswordTransaction(String eMail, Student student) throws SQLException;
