...
public class AddCourseController implements Initializable {
    ...
    @FXML
    private Label lblInvalidProfessor;
    ...
    private Semester getSemester() {
        ...
        try {
            ...
            Logger.getLogger(AddCourseController.class.getName()).log(Level.SEVERE, null, parseException);
            DialogGenerator.getDialog(new AlertMessage(
    ...
    private boolean validateFields() {
        ...
        if (cbxProfessor.getSelectionModel().isEmpty()) {
            result = false;
            lblInvalidProfessor.setVisible(true);
        }
    ...
    private void setCourse(Course course, Semester semester) {
        ...
        course.setProfessorId(getProfessor());
        course.setCourseId();
    }
}
