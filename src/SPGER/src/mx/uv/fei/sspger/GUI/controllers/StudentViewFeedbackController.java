...
public class StudentViewFeedbackController implements Initializable {
    ...
    public static void setIdSubmission(int idSubmission) {
        StudentViewFeedbackController.idSubmission = idSubmission;
    }
    ...
    private void showFeedbackPane() {
        try {
            ...
            Logger.getLogger(StudentViewFeedbackController.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void goBackButtonClicked(ActionEvent event) {
        SPGER.setRoot("SubmissionConcludedDetails.fxml");
    }
