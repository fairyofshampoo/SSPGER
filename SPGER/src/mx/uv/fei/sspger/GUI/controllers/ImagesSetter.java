...
public class ImagesSetter {
    ...
    private static final Image GO_BACK_IMAGE = new Image(ImagesSetter.class.getResourceAsStream("/mx/uv/fei/sspger/GUI/resources/btnBack.png"));
    private static final Image MY_PROJECT_IMAGE = new Image(ImagesSetter.class.getResourceAsStream("/mx/uv/fei/sspger/GUI/resources/btnMyProject.png"));
    ...
    public static Image getGoBackImage() {
        return GO_BACK_IMAGE;
    }

    public static Image getMyProjectImage() {
        return MY_PROJECT_IMAGE;
    }

    public static Image getProjectsImage() {
